...
async function main(): Promise<void> {
    ...
    if (await exists('README.md')) {
        ...
        const readme = [
            ...
            '- **Viewing**: Install the [Sourcegraph browser extension](https://docs.sourcegraph.com/integration/browser_extension).',
            '',
            '## Set up',
            '',
            '```',
            ...
            '',
            'Visit [Sourcegraph extensions documentation](https://docs.sourcegraph.com/extensions) and check out some [sample Sourcegraph extensions](https://github.com/sourcegraph/sourcegraph-extension-samples).',
            '',
        ].join('\n')
